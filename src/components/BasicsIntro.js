...
const BasicsIntro = props => {
    return(
        <div id="Basics-Intro" className="basics-component">
            ...
            <ol>
                <li className="text-med">There are now <span className="text-med-bold">Stats</span> for professions. Each of them improve certain aspects of your crafting or gathering.</li>
                <li className="text-med">All professions now have <span className="text-med-bold">Equipment</span> - three different items that improve crafting or gathering by giving you different stats.</li>
